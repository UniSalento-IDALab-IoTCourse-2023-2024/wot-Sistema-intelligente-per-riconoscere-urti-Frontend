...
class _AdminPageState extends State<AdminPage> {
  ...
  Future<void> fetchUserCount() async {
    final response = await http.get(Uri.parse('http://192.168.1.11:5001/api/utenti/'));
  ...
  Future<void> _loadIncidents([String? username]) async {
    ...
    try {
      String apiUrl = username == null || username == 'Tutti'
          ? 'http://192.168.1.11:5001/api/incidenti/'
          : 'http://192.168.1.11:5001/api/incidenti/get_incidenti_by_username/$username';
